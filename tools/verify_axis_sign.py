...
def verify():
    ...
    expected=['chart_radial_derivative_eq_fderiv','first_jet_radial_component_tends_zero','axial_derivative_tail_tends_zero','power_bounded_remainder_tends_zero','uncut_prefix_derivative_tends_leading','uncut_prefix_as_positive_sum','finite_prefix_derivative_tends_leading','finite_prefix_radial_derivative','finite_positive_prefix_tends_zero','selected_axial_component_derivative_tail','axial_component_derivative_tail','natural_radial_derivative_quantitative','natural_radial_derivative_negative_at_root','natural_axis_radial_identity_from_solution','natural_axis_radial_identity','actual_axis_force_ratio_negative','exists_negative_axis_force_ratio']
