...
def verify():
    ...
    expected=['selected_axial_component_derivative_tail','axial_component_derivative_tail','natural_radial_derivative_quantitative','natural_radial_derivative_negative_at_root','natural_axis_radial_identity_from_solution','natural_axis_radial_identity','actual_axis_force_ratio_negative','exists_negative_axis_force_ratio']
